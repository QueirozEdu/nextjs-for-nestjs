    ...
    return (
        ...
        >
            ...
            <Dialog
                content={
                    <p>
                        When I delete my account, my data and all my posts will
                        also be deleted. This action is IRREVERSIBLE. In a few
                        seconds, the buttons will be released. Click <b>OK</b>{" "}
                        to confirm or <b>Cancel</b> to close this window
                    </p>
                }
                disabled={isElementsDisabled}
